    ...
    <section className="py-16 md:py-20 bg-cajun-red">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-white/80 font-semibold text-xs md:text-sm tracking-[0.2em] uppercase mb-4">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto bg-gold hover:bg-gold-light text-charcoal text-base px-8 py-6 rounded-full shadow-lg font-semibold"
            >
              <Link href="/catering">
                Book Catering
              </Link>
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="w-full sm:w-auto border-2 border-white text-white hover:bg-white hover:text-cajun-red text-base px-8 py-6 rounded-full"
            >
